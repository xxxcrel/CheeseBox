...
import beer.cheese.hollow.connector.Constants;
...
import beer.cheese.hollow.util.http.HeaderUtil;
import beer.cheese.hollow.util.http.MimeHeaders;
import beer.cheese.hollow.util.http.parser.HttpParser;
...
public abstract class AbstractInputBuffer<S> implements InputBuffer{
    ...
    protected abstract void init(SocketWrapper<S> socketWrapper) throws IOException;

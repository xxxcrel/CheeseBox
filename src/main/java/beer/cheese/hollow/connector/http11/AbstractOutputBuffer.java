...
import beer.cheese.hollow.connector.endpoint.SocketWrapper;
import beer.cheese.hollow.connector.http11.filters.GzipOutputFilter;
...
import beer.cheese.hollow.util.buf.CharChunk;
import beer.cheese.hollow.util.buf.MessageBytes;
import beer.cheese.hollow.util.http.HttpMessages;
import beer.cheese.hollow.util.res.StringManager;
...
//            response.action(ActionCode.COMMIT, null);
    ...
    public abstract void init(SocketWrapper<S> socketWrapper) throws IOException;
    ...
    public void sendStatus() {
        ...
        // Write message
        String message = null;
        if (beer.cheese.hollow.connector.Constants.USE_CUSTOM_STATUS_MSG_IN_HEADER &&
        ...
        if (beer.cheese.hollow.connector.Constants.IS_SECURITY_ENABLED){
